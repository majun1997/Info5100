...
public class ViewPanel extends javax.swing.JPanel {
    ...
    ViewPanel(Product prod, ProductDirectory prodDir, JPanel rightPanel) {
        initComponents();
        this.product=prod;
        txtAvailablity.setText(String.valueOf(prod.getAvailNum()));
        txtPrice.setText(String.valueOf(prod.getPrice()));
        ...
        this.prodDir = prodDir; //To change body of generated methods, choose Tools | Templates.
    }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        // TODO add your handling code here:
            ...
            try
            {
                ...
                JOptionPane.showMessageDialog(null, "please enter a number for availablity");
            }
