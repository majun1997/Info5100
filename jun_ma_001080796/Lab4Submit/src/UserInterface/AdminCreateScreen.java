...
public class AdminCreateScreen extends javax.swing.JPanel {
        ...
        txtRePword.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void warn() {
               if(!txtPword.getText().equals(txtRePword.getText()))
                   ...
                   txtRePword.setBorder(borderOri);
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if(radioCustomer.isSelected()){
            Customer a=new Customer(p1,username);
            admin.getCustDir().addCust(a);
            JOptionPane.showMessageDialog(null, "Customer created Successfully");
            toMainScreen();
            return;
        }
        if(radioSupplier.isSelected()){
            Supplier a=new Supplier(p1,username);
            
            admin.getSuppDir().addsupplier(a);
    ...
    private boolean usernamePatternCorrect() {
        Pattern p=Pattern.compile("^[a-zA-Z_0-9]+_[a-zA-Z_0-9]+@[a-zA-Z_0-9]+\\.[a-zA-Z_0-9]+");
