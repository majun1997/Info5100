...
public class TravelAgencyLogin extends javax.swing.JPanel {
    ...
    public TravelAgencyLogin(UserList userList,JPanel rightPanel) {
        initComponents();
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        if(userList.getAdmin().getUserName().equals(username))
            if(userList.getAdmin().verify(password))
            {
                JOptionPane.showMessageDialog(null, "success");
                CardLayout layout = (CardLayout)rightPanel.getLayout();
                rightPanel.add("AgencyPanel",new AgencyPanel(userList,rightPanel));
